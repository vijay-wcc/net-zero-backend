...
def create_an_organization(organization_in: OrganizationCreate,
...
def read_organizations(skip: int = 0, limit: int = 100,
                       db: Session = Depends(get_db)):
...
def update_item(org_id: str, organization: OrganizationUpdate,
                db: Session = Depends(get_db)):
